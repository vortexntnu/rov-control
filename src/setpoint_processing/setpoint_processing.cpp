...
void SetpointProcessing::updateDepthHold(const maelstrom_msgs::JoystickMotionCommand& msg)
{
    ...
    depth_hold_msg.force.x  = msg.forward * MAX_FORCE;
    depth_hold_msg.force.y  = msg.right   * MAX_FORCE;
    depth_hold_msg.force.z  = 0;
    depth_hold_msg.torque.x = 0;
    depth_hold_msg.torque.y = msg.tilt_up    * MAX_TORQUE;
    depth_hold_msg.torque.z = msg.turn_right * MAX_TORQUE;
