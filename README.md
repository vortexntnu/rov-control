...
## Testing/linting
Tests run automatically on a Travis server. Run tests manually with `catkin_make run_tests`. Linting is done when running tests, but you can do linting separately with `catkin_make roslint`.
