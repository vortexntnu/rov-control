...
def callback(ForceInput):
    ...
    PwmStatusMsg.pwm1 = int(LookupTable.force_to_pwm(ForceInput.F1))
    PwmStatusMsg.pwm2 = int(LookupTable.force_to_pwm(ForceInput.F2))
    PwmStatusMsg.pwm3 = int(LookupTable.force_to_pwm(ForceInput.F3))
    PwmStatusMsg.pwm4 = int(LookupTable.force_to_pwm(ForceInput.F4))
    PwmStatusMsg.pwm5 = int(LookupTable.force_to_pwm(ForceInput.F5))
    PwmStatusMsg.pwm6 = int(LookupTable.force_to_pwm(ForceInput.F6))
...
def init_pwm():
    ...
    pwm_zero_newton = int(LookupTable.force_to_pwm(0))
