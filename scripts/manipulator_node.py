...
class ManipulatorNode():
	...
	# Control signal from pin 11, 13 and 15
        pwmpin_grip, pwmpin_base, pwmpin_base2, pwmpin_rot = 11, 15, 16, 13
	...
	self.base2_angle = 180 - self.base_angle
	...
	print self.grip_angle, self.base_angle, self.base2_angle, self.rot_angle
